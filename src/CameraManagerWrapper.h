...
#ifndef CAMERAMANAGERWRAPPER_H
#define CAMERAMANAGERWRAPPER_H
...
// Wrapper for CameraManager
struct CameraManagerWrap : CameraManager, python::wrapper<CameraManager>
{
};

#endif // CAMERAMANAGERWRAPPER_H
